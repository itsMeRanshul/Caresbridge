      ...
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <nav
          className={`flex gap-6 md:static md:flex ${
            isMenuOpen
              ? 'absolute top-full right-0 bg-gray-900 flex-col p-4'
              : 'hidden md:flex'
          }`}
        >
          <NavLink
          ...
          <Link
            ...
            className="bg-gray-400 text-white px-3 py-1 rounded hover:bg-pink-600 hover:text-white transition-colors relative"
          >
            Login
            {showDropdownMessage && (
            ...
            <Link
            to="/cart"
            className="relative text-white mt-1 hover:text-pink-600 transition-colors"
          >
            <svg
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="absolute top-full right-0 bg-gray-900 w-full flex flex-col items-center p-4">
            <NavLink
              to="/"
              exact
              className={({ isActive }) =>
